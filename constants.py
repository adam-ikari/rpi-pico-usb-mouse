...
BEZIER_MAX_STEPS = 50
BEZIER_MIN_STEPS = 15
BEZIER_CONTROL_POINT_VARIANCE = 0.3

# Perlin 噪声参数
PERLIN_FREQUENCY_WEB_BROWSE = 2.0
PERLIN_FREQUENCY_SCAN = 1.5
PERLIN_FREQUENCY_CIRCULAR = 1.5
PERLIN_FREQUENCY_FOCUS = 3.0
PERLIN_AMPLITUDE_SMALL = 0.5
PERLIN_AMPLITUDE_MEDIUM = 2.0
PERLIN_AMPLITUDE_LARGE = 5.0

# 风力算法参数
WIND_STRENGTH_DEFAULT = 3.0
WIND_FREQUENCY = 0.5

# 椭圆轨迹参数
ELLIPSE_RADIUS_VARIANCE_MIN = 0.7
ELLIPSE_RADIUS_VARIANCE_MAX = 1.3

# 重力算法参数
GRAVITY_STRENGTH_DEFAULT = 0.15
GRAVITY_STRENGTH_STRONG = 0.25